...
export const metadata: Metadata = {
  title: "IndiGo Airlines - India's Favorite Low-Cost Carrier",
  description: "Book flights with IndiGo - India's leading airline offering on-time performance, affordable fares, and 100+ destinations. Experience hassle-free travel.",
  keywords: "IndiGo airlines, cheap flights India, domestic flights, international flights, airline booking, low cost carrier",
  metadataBase: new URL("https://www.goindigo.in"),
  alternates: {
    canonical: "https://www.goindigo.in"
  },
  openGraph: {
    title: "IndiGo Airlines - Fly Smart, Fly IndiGo",
    description: "Experience India's favorite airline with on-time performance and affordable fares to 100+ destinations.",
    siteName: "IndiGo Airlines",
    images: [{
      url: "https://images.pexels.com/photos/804804/pexels-photo-804804.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "IndiGo aircraft flying"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "IndiGo Airlines - India's Leading Low-Cost Carrier",
    description: "Book affordable flights with India's most punctual airline to 100+ destinations.",
    images: ["https://images.pexels.com/photos/804804/pexels-photo-804804.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
